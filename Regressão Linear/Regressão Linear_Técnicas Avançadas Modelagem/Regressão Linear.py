...
# distribuição de Frequêmcia do 'Valor'
...
# nesta biblioteca temos que informar o valor do intercpto
...
# resumo das estatísticasdo modelo OLS
print(modelo_statsmodels.summary())


# - R-squared: R² - coeficiente de determinação;
# - Adj. R-squared: considera os graus de liberade, pode diminuir com adição de variáveis;
# - F-statistic: teste F, significância CONJUNTA das variáveis explicativas (0 ou não)
# - Prob (F-statistic) > 0.05: rejeita-se o modelo, não é estatisticamente significante;
# - t: teste t, significância INDIVIDUAL para cada variável (0 ou não)
# - P>|t|: do mesmo modo, não deve ser maior que 0.05
...
# retiramos log_Dist_Farmacia, não passou no teste individual
